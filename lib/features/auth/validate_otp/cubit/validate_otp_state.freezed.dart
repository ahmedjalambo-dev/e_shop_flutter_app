...
class Loading implements ValidateOtpState {
  const Loading();
...
class Success implements ValidateOtpState {
...
@override
String toString() {
  return 'ValidateOtpState.success(message: $message)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<$Res> implements $ValidateOtpStateCopyWith<$Res> {
...
class Failure implements ValidateOtpState {
...
@override
String toString() {
  return 'ValidateOtpState.failure(message: $message)';
}
...
/// @nodoc
abstract mixin class $FailureCopyWith<$Res> implements $ValidateOtpStateCopyWith<$Res> {
