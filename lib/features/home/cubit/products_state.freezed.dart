...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( ProductsResponse productsResponse)?  success,TResult Function( String message)?  failure,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case Loading() when loading != null:
return loading();case Success() when success != null:
return success(_that.productsResponse);case Failure() when failure != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( ProductsResponse productsResponse)  success,required TResult Function( String message)  failure,}) {final _that = this;
switch (_that) {
case _Initial():
return initial();case Loading():
return loading();case Success():
return success(_that.productsResponse);case Failure():
return failure(_that.message);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( ProductsResponse productsResponse)?  success,TResult? Function( String message)?  failure,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case Loading() when loading != null:
return loading();case Success() when success != null:
...
class Success implements ProductsState {
  const Success(this.productsResponse);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Success&&(identical(other.productsResponse, productsResponse) || other.productsResponse == productsResponse));
}
...
@override
String toString() {
  return 'ProductsState.success(productsResponse: $productsResponse)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<$Res> implements $ProductsStateCopyWith<$Res> {
...
class Failure implements ProductsState {
...
/// @nodoc
abstract mixin class $FailureCopyWith<$Res> implements $ProductsStateCopyWith<$Res> {
